...
if [ -n "$PORT_ROOT" ]; then
    ...
    export PORT_ROOT PORT_BUILD ANDROID_TOP ANDROID_OUT ANDROID_BRANCH PORT_PRODUCT PARTNER PATCHROM_BRANCH OTA_ASSERT_DEVICE ANDROID_PLATFORM
